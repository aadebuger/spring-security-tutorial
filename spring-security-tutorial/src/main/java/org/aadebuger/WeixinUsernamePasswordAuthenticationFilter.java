 ...
 * @since 3.0
 */
public class WeixinUsernamePasswordAuthenticationFilter extends UsernamePasswordAuthenticationFilter
{
    ...
    public WeixinUsernamePasswordAuthenticationFilter() {
        super();
    }
